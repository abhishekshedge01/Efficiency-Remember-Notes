...
public class ForgotPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed1=findViewById(R.id.passwordsignin);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(mail)) {
                 ...
                 {
                    firebaseAuth.sendPasswordResetEmail(mail).addOnCompleteListener(ForgotPassword.this, new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task)
                        {
                            ...
                            {
                                Toast.makeText(ForgotPassword.this, "Mail enter is wrong or not Registerd", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
